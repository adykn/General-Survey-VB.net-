        ...
        Try
            For i = 0 To dt.Rows.Count - 1
                With dgg
                    ...
                    If dt2.Rows(i).Item("Question").ToString.Length = 0 Then
                        .Rows(i).Cells(2).ReadOnly = IIf(dt2.Rows(i).Item("Question").ToString.Length = 0, False, True)
                    Else
                        ' .Rows(i).Cells(2).ReadOnly = IIf(dt2.Rows(i).Item("Question").ToString.Split(" ")(0).ToLower = "other", True, False)
                    End If
        ...
        If bbSave.Text = "Save" Then
            ...
            For i = 0 To dg.Rows.Count - 1
                With dg.Rows(i)
                    ...
                    '{"Id", "Ref", "Num", "Date_", "Skill", "Rank", "NumOfHr"}
                    v(0) = Max(t, "", "Id") + 1
